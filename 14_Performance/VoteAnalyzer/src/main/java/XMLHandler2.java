...
public class XMLHandler2 extends DefaultHandler {
    ...
    private HashMap<Integer, WorkTime2> voteStationWorkTimes;
...
//                String birthDayStr = new String
               ...
               voterCounts.put(voter, count + 1);
                ...
                WorkTime2 workTime = voteStationWorkTimes.get(station);
                if(workTime == null)
                {
                    workTime = new WorkTime2();
...
//            }
    ...
    public void printStationWorkTime(){
        ...
        {
            WorkTime2 workTime = voteStationWorkTimes.get(votingStation);
